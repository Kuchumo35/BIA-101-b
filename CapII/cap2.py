class Income:
    def __init__(self, salary):
        # Initializing income attributes
        self.salary = salary
...
class Deductions:
    ...
    GIS_max = 50000  # Maximum GIS deductible 
...
def run_tax_calculation():
    ...
    organization_type = input("Enter the type of organization you work in (government/private): ").lower()
    ...
    for i in range(children):
        enrolled_for_education = input(f"Is the child {i+1} enrolled for education? (yes/no): ").lower()
